...
Wordmark: "LocaInfra" in Geist 600, letter-spacing −0.02em (−0.03em above 24 px). Lit cell may take the brand accent when one is chosen; everything else stays neutral.
