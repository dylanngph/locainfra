...
- Allowed barrels (override in `biome.json`): each package entry `packages/*/src/index.ts`, the `@locastack/core/testing` entry, and the shadcn-mandated `dashboard/src/lib/utils.ts` alias.
