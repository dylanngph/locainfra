/** Prefix shared by every Docker label LocaStack sets. */
export const LABEL_PREFIX = "locastack.";

/** Label carrying the project (stack) name on containers, volumes and networks. */
export const LABEL_STACK = "locastack.stack";
