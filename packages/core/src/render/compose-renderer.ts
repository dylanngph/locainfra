...
/** One compose service as rendered by LocaStack. */
export interface ComposeService {
	/** Image reference. */
	image: string;
	/** Container name, `ls-<stack>-<service>`. */
...
/** The compose document LocaStack renders for a stack. */
 ...
 * @returns The container name, `ls-<stack>-<service>`.
 */
 ...
 * the compose service `<instance>` with container `ls-<project>-<instance>`;
...
export function renderCompose(stack: ResolvedStack): string {
	const header = `# Generated by LocaStack for stack "${stack.name}". Do not edit: changes are overwritten.\n# Change the stack from the dashboard or its stack file instead.\n`;
	return (
		header +
...
export function renderComposeEnvFile(stack: ResolvedStack): string {
	...
	return `# Generated by LocaStack: secrets for docker compose interpolation. Do not commit.\n${dotenvFormatter.format(vars)}`;
}
