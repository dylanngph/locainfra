 ...
 * keep running). `LOCASTACK_E2E_PORT` overrides the default 4598.
 */
export const E2E_PORT = Number(process.env.LOCASTACK_E2E_PORT ?? 4598);

/** Fixed session token passed through `LOCASTACK_SESSION_TOKEN`. */
export const E2E_TOKEN = "locastack-e2e-session-token";

/** Project the M2 smoke creates (containers `ls-m2-smoke-*`). */
export const E2E_PROJECT = "m2-smoke";

/** Project the M3a smoke creates (containers `ls-m3a-smoke-*`). */
export const M3A_PROJECT = "m3a-smoke";

/** Project the M3b smoke imports (containers `ls-m3b-smoke-*`). */
...
export const E2E_ENABLED = process.env.LOCASTACK_E2E === "1";
...
export const E2E_SCRATCH_ENV = "LOCASTACK_E2E_SCRATCH";
